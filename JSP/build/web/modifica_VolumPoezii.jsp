...
<div id="main">
  ...
  <p align="center"><a href="nou_VolumPoezii.jsp"><b>Adauga un volum nou.</b></a>  </font>      
           
    <body>
        <br/>
         <form action="m1_VolumPoezii.jsp" method="post">
            <table border="1" align="center">
                <tr>
                    <td><b>Mark</b></td>
                    <td><b>IdVolumPoezii</b></td>
                    <td><b>IdPoet</b></td>
                    <td><b>Nume</b></td>
                    <td><b>Prenume</b></td>
                    ...
                    <td><b>ISBN:</b></td>
                    <td><b>NumeVolum</b></td>
                    <td><b>DataLAnsare</b></td>
                    <td><b>Tema</b></td>
                </tr>
                <%
                    jb.connect();
                    ResultSet rs = jb.vedeVolumPoezii();
                    long x;
                    while (rs.next()) {
